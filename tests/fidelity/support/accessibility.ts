...
type NormalizedNode = { role: string; name?: string; value?: unknown; description?: string; states?: Record<string, unknown>; children?: NormalizedNode[] };
...
export function normalizeAccessibilityTree(nodes: RawAccessibilityNode[]): NormalizedNode | null {
  ...
  const visit = (node: RawAccessibilityNode): NormalizedNode => {
