...
export function HasNoJobsDeployed({ environmentLabel }: { environmentLabel: string }) {
    ...
    <div>
      <div className="mb-2 flex items-center justify-between border-b">
        <div className="mb-2 flex min-w-0 items-center gap-2">
          ...
          <Header1 className="truncate">Dispatch jobs to {environmentLabel}</Header1>
        </div>
      </div>
      ...
      <div className="mr-3">
        <div className="flex items-center gap-x-3">
          ...
          <div className="flex items-center gap-x-2">
            <Header2>Waiting for jobs to run</Header2>
            <Spinner />
          </div>
        </div>
      </div>
      <div className="mb-6 ml-9 mt-1">
        <Paragraph>This page will automatically refresh when jobs are observed.</Paragraph>
      </div>
    </div>
  );
}
