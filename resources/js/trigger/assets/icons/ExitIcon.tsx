/* Adapted from Trigger.dev at ca9a74e84abdf9483c234e82dc54b9ec2c00d8c0; formatting only. */
export function ExitIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8.5 4.5L12 8L8.5 11.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
