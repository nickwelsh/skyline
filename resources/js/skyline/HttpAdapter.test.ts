...
describe("HttpAdapter", () => {
  it("encodes Telemetry-event search and list filters", async () => {
  ...
  it("encodes Job list and detail URL state", async () => {
    ...
    await adapter.job("job/opaque", { from: "1785859200000", to: "1785945600000" });
    ...
    expect(String(fetch.mock.calls[2][0])).toBe("/monitoring/api/jobs/job%2Fopaque?from=1785859200000&to=1785945600000");
  });
