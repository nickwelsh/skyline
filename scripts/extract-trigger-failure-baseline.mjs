...
const baseline = {
  ...
  contract: {
    failure: { visibleLineLimit: 20, structuredFrames: "skyline-extension" },
    capture: { copy: true, wrap: true, expand: true, focusManagedDialog: true },
    copyFeedback: { idle: "Copy", copied: "Copied" },
  },
};
